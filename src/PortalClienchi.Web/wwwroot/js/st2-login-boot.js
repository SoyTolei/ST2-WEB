/**
 * Boot temprano: Silk del login + Lightfall del splash (ligero, no bloquea “ver como”).
 * AeroShards queda fuera del path crítico: WebGPU congelaba el reload.
 */
...
import { initSplashLightfall, startSplashLightfall, stopSplashLightfall } from "./st2-lightfall.js?v=20260914d";
